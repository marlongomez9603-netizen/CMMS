...
const SECTORS = [
    // ===== SECTOR 0: PETRÓLEO Y GAS =====
    {
        ...
        techPool: [
            { name: 'Juan Carlos Herrera', role: 'Técnico Mecánico', specialization: 'Equipos Rotativos', shift: 'Diurno (6am-6pm)' },
            { name: 'Andrés Felipe Ruiz', role: 'Técnico Mecánico', specialization: 'Compresores y Bombas', shift: 'Diurno (6am-6pm)' },
            { name: 'Diana Marcela Torres', role: 'Ingeniera de Confiabilidad', specialization: 'Análisis Predictivo', shift: 'Administrativo (8am-5pm)' },
            { name: 'Pedro Alonso Díaz', role: 'Técnico Electricista', specialization: 'Alta y Media Tensión', shift: 'Nocturno (6pm-6am)' },
            { name: 'Laura Sofía Ramírez', role: 'Técnico Instrumentista', specialization: 'Instrumentación Industrial', shift: 'Diurno (6am-6pm)' },
            { name: 'Carlos Mario Peña', role: 'Técnico de Lubricación', specialization: 'Tribología', shift: 'Diurno (6am-6pm)' },
            { name: 'Ángela Patricia Gómez', role: 'Supervisora de Mantenimiento', specialization: 'Gestión de Activos', shift: 'Administrativo (8am-5pm)' }
        ],
        inventoryPool: [
    ...
    // ===== SECTOR 1: MANUFACTURA / MECANIZADO =====
    {
        ...
        techPool: [
            { name: 'Ricardo José Ospina', role: 'Técnico CNC', specialization: 'Máquinas Herramienta CNC', shift: 'Diurno (7am-5pm)' },
            { name: 'Leonardo Fabio Mejía', role: 'Técnico de Mantenimiento', specialization: 'Sistemas Hidráulicos', shift: 'Diurno (7am-5pm)' },
            { name: 'Camila Andrea Restrepo', role: 'Ingeniera de Mantenimiento', specialization: 'Planificación y Confiabilidad', shift: 'Administrativo (8am-5pm)' },
            { name: 'Jorge Enrique Castillo', role: 'Técnico Soldador', specialization: 'Soldadura y Metalurgia', shift: 'Diurno (7am-5pm)' },
            { name: 'Sandra Patricia Rojas', role: 'Técnico de Metrología', specialization: 'Control de Calidad', shift: 'Diurno (7am-5pm)' },
            { name: 'Edison Fabio Ríos', role: 'Técnico Electricista', specialization: 'Motores y Variadores', shift: 'Nocturno (7pm-5am)' },
            { name: 'María Fernanda López', role: 'Supervisora de Producción', specialization: 'Gestión de Mantenimiento', shift: 'Administrativo (8am-5pm)' }
        ],
        inventoryPool: [
    ...
    // ===== SECTOR 2: AGROINDUSTRIA =====
    {
        ...
        techPool: [
            { name: 'Miguel Ángel Parra', role: 'Técnico de Maquinaria', specialization: 'Motores Diésel', shift: 'Diurno (6am-4pm)' },
            { name: 'Fabián Enrique Castro', role: 'Técnico Electromecánico', specialization: 'Sistemas de Riego', shift: 'Diurno (6am-4pm)' },
            { name: 'Sandra Patricia Muñoz', role: 'Supervisora de Mantenimiento', specialization: 'Gestión de Activos', shift: 'Administrativo (7am-4pm)' },
            { name: 'Carlos Alberto Pérez', role: 'Técnico Agrícola', specialization: 'Maquinaria Pesada', shift: 'Diurno (6am-4pm)' },
            { name: 'Ana María González', role: 'Técnico Eléctrico', specialization: 'Automatización Agrícola', shift: 'Diurno (7am-4pm)' },
            { name: 'Héctor Julio Rincón', role: 'Técnico de Lubricación', specialization: 'Mantenimiento Preventivo', shift: 'Diurno (6am-4pm)' },
            { name: 'Luz Dary Ortega', role: 'Ingeniera de Procesos', specialization: 'Post-cosecha', shift: 'Administrativo (7am-4pm)' }
        ],
        inventoryPool: [
    ...
    // ===== SECTOR 3: MINERÍA / CEMENTOS =====
    {
        ...
        techPool: [
            { name: 'Rodrigo Alejandro Vega', role: 'Técnico Mecánico', specialization: 'Equipos Pesados', shift: 'Diurno (6am-6pm)' },
            { name: 'Wilson Eduardo Mora', role: 'Técnico Eléctrico', specialization: 'Potencia y Control', shift: 'Diurno (6am-6pm)' },
            { name: 'Natalia Andrea Silva', role: 'Ingeniera de Mantenimiento', specialization: 'Planeación y Programación', shift: 'Administrativo (7am-5pm)' },
            { name: 'Oscar Fernando Ríos', role: 'Técnico de Lubricación', specialization: 'Tribología Industrial', shift: 'Diurno (6am-6pm)' },
            { name: 'Diego Armando López', role: 'Técnico Hidráulico', specialization: 'Sistemas Hidráulicos Pesados', shift: 'Diurno (6am-6pm)' },
            { name: 'Julio César Amaya', role: 'Operador de Planta', specialization: 'Trituración y Molienda', shift: 'Rotativo (3 turnos)' },
            { name: 'Carolina Esther Flórez', role: 'Técnico Instrumentista', specialization: 'Automatización de Procesos', shift: 'Diurno (7am-5pm)' }
        ],
        inventoryPool: [
    ...
    // ===== SECTOR 4: ENERGÍA / ELÉCTRICO =====
    {
        ...
        techPool: [
            { name: 'Fernando Antonio Cruz', role: 'Ingeniero Eléctrico', specialization: 'Protecciones y Relés', shift: 'Administrativo (8am-5pm)' },
            { name: 'Martha Lucía Vargas', role: 'Técnico de Subestaciones', specialization: 'Alta Tensión', shift: 'Diurno (6am-6pm)' },
            { name: 'Héctor Julio Mendoza', role: 'Técnico Electrónico', specialization: 'Control y Automatización', shift: 'Diurno (7am-5pm)' },
            { name: 'Paola Andrea Jiménez', role: 'Técnico Instrumentista', specialization: 'Sistemas SCADA', shift: 'Diurno (7am-5pm)' },
            { name: 'Sergio Iván Martínez', role: 'Técnico Mecánico', specialization: 'Turbomaquinaria', shift: 'Rotativo (3 turnos)' },
            { name: 'Cristian David Barrera', role: 'Técnico de Baterías', specialization: 'Sistemas DC y UPS', shift: 'Diurno (7am-5pm)' },
            { name: 'Ingrid Johanna Pedraza', role: 'Supervisora de Operaciones', specialization: 'Gestión de Energía', shift: 'Administrativo (8am-5pm)' }
        ],
        inventoryPool: [
    ...
    // ===== SECTOR 5: ALIMENTOS / PROCESAMIENTO =====
    {
        ...
        techPool: [
            { name: 'Gloria Esperanza Duarte', role: 'Técnico de Refrigeración', specialization: 'Cadena de Frío', shift: 'Diurno (6am-4pm)' },
            { name: 'Manuel Enrique Sánchez', role: 'Técnico Mecánico', specialization: 'Líneas de Producción', shift: 'Diurno (6am-4pm)' },
            { name: 'Adriana Carolina Pineda', role: 'Ingeniera de Mantenimiento', specialization: 'Inocuidad y BPM', shift: 'Administrativo (7am-4pm)' },
            { name: 'Jhon Fredy Gómez', role: 'Técnico Eléctrico', specialization: 'Automatización Industrial', shift: 'Nocturno (6pm-6am)' },
            { name: 'Viviana Marcela Ortiz', role: 'Técnico de Calderas', specialization: 'Generación de Vapor', shift: 'Rotativo (3 turnos)' },
            { name: 'Edwin Andrés Cárdenas', role: 'Técnico Instrumentista', specialization: 'Sensores y PLC', shift: 'Diurno (7am-5pm)' },
            { name: 'Dora Liliana Quintero', role: 'Supervisora de Planta', specialization: 'Gestión de Producción', shift: 'Administrativo (7am-4pm)' }
        ],
        inventoryPool: [
